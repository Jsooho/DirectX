...
bool LineShape::CreateVertexData()
{
   ...
   /* m_LineVertexList[2].pos = TVector3(0.0f, 0.0f, 0.0f);
    m_LineVertexList[2].Color = TVector4(0.0f, 1.0f, 0.0f, 1.0f);
    m_LineVertexList[3].pos = TVector3(0.0f, 1.0f, 0.0f);
    m_LineVertexList[3].Color = TVector4(0.0f, 1.0f, 0.0f, 1.0f);


    m_LineVertexList[4].pos = TVector3(0.0f, 0.0f, 0.0f);
    m_LineVertexList[4].Color = TVector4(0.0f, 0.0f, 1.0f, 1.0f);
    m_LineVertexList[5].pos = TVector3(0.0f, 0.0f, 1.0f);
    m_LineVertexList[5].Color = TVector4(0.0f, 0.0f, 1.0f, 1.0f);*/
    return true;
}
