...
bool Frustum::CreateFrustum(TMatrix& matView, TMatrix& matProj)
{
    ...
    {
        // z+
        m_vertexList[0].pos = m_vFrustum[5];
        m_vertexList[1].pos = m_vFrustum[4];
        m_vertexList[2].pos = m_vFrustum[7];
        m_vertexList[3].pos = m_vFrustum[6];

        // z-
        m_vertexList[4].pos = m_vFrustum[0];
        m_vertexList[5].pos = m_vFrustum[1];
        m_vertexList[6].pos = m_vFrustum[2];
        m_vertexList[7].pos = m_vFrustum[3];

        //x+
        m_vertexList[8].pos = m_vFrustum[1];
        m_vertexList[9].pos = m_vFrustum[5];
        m_vertexList[10].pos = m_vFrustum[3];
        m_vertexList[11].pos = m_vFrustum[7];

        //x-
        m_vertexList[12].pos = m_vFrustum[4];
        m_vertexList[13].pos = m_vFrustum[0];
        m_vertexList[14].pos = m_vFrustum[6];
        m_vertexList[15].pos = m_vFrustum[2];
        
        //y+
        m_vertexList[16].pos = m_vFrustum[4];
        m_vertexList[17].pos = m_vFrustum[5];
        m_vertexList[18].pos = m_vFrustum[0];
        m_vertexList[19].pos = m_vFrustum[1];

        //y-
        m_vertexList[20].pos = m_vFrustum[2];
        m_vertexList[21].pos = m_vFrustum[3];
        m_vertexList[22].pos = m_vFrustum[6];
        m_vertexList[23].pos = m_vFrustum[7];
   ...
   // 6   7
    ...
    //x-
    m_Plane[2] = TPlane(m_vFrustum[4], m_vFrustum[0], m_vFrustum[2]);

    //x+
    m_Plane[3] = TPlane(m_vFrustum[1], m_vFrustum[5], m_vFrustum[7]);

    //y-
    m_Plane[4] = TPlane(m_vFrustum[7], m_vFrustum[6], m_vFrustum[2]);

    //y+
    m_Plane[5] = TPlane(m_vFrustum[4], m_vFrustum[5], m_vFrustum[0]);
